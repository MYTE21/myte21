...
|:---------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------:|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <a href = "https://github.com/MYTE21/COVID.Death" target="_blank"><img src="assets/covid_19.jpg" style="width: 50px;" alt=""></a> | <a href="https://github.com/MYTE21/COVID.Death"><b>COVID.Death</a> | ![activity.png](assets/activity.png) `Active`<br/> 1. `Exploring` and `Analyzing` the global dataset `Coronavirus`.<br/> 2. Constructing an `Interactive Dashboard` to display the Coronavirus's global impact. | <img src="assets/mysql.svg" alt="my-sql logo"> <img height="25em" src="assets/tableau.png" alt="tableau logo"> <img height="25em" src="assets/datagrip.svg" alt="datagrip logo"> |
